...
# git remote add <variable_name>(обычно origin) <link to repository> - 
# связка локального репозитория с удаленным и сохранене ссылки в переменную
...
# git pull origin <branch name> - стягивание.добавление изменений с указанной ветки в текущую
